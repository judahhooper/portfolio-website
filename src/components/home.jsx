...
const Home = () => {
  return (
    ...
    <div className='max-w-[1000px] mx-auto px-8 flex-col justify-center h-full translate-y-[30%] top-[50] md:translate-x-[-25%] z-10'>
        ...
        <h2 className='text-4xl sm:text-7xl font-bold text-slate-800 py-4'>I'm looking to work as a junior developer.</h2>
        ...
        <div>
        <Link to="work" smooth={true} duration={500}><button className='text-slate-800 group border-2 px-6 py-3 my-2 border-slate-200 flex items-center hover:bg-[#BF5700] hover:text-slate-200 hover:border-slate-700 '>
        See what I've made
